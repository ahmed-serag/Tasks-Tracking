...
export const Layout: React.FC<LayoutProps> = ({ children }) => {
  return (
    <div className="min-h-screen bg-elegant-cream text-elegant-slate">
          ...
          <div className="flex justify-between h-16 items-center">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-serif font-bold text-gray-900 tracking-tight">
                Bliss<span className="text-primary-600">Plan</span>
              </h1>
            </div>
            <div className="text-sm text-gray-500 hidden sm:block">
              Your Complete Wedding Organizer
            </div>
          </div>
        </div>
      </header>
      ...
      <footer className="bg-white border-t border-gray-100 py-6 mt-12">
        <div className="max-w-7xl mx-auto px-4 text-center text-gray-400 text-sm">
          &copy; {new Date().getFullYear()} BlissPlan. All rights reserved.
        </div>
      </footer>
    </div>
  );
